...
const { pushBackupToGithub, scheduleDbPersist } = require('./github-persist');
...
async function createBackupFromLive(atDate) {
  ...
  pushBackupToGithub(id, manifest).catch(function(e) {
...
async function restoreBackup(backupId) {
  ...
  writeManifest(manifest);
  scheduleDbPersist();
  pushBackupToGithub(backupId, manifest).catch(function(e) {
