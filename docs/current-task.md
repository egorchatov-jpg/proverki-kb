...
- **Дата:** 2026-08-19
- **Сессия:** Ширина относительно видимого экрана + закругление фото-кнопок (pkb-v350)
- **Версия кода:** pkb-v350 (последний закоммиченный в master — pkb-v349, 401c0be)
- **Статус:** НЕ закоммичено (правки в рабочей копии)

## Что сделано
1. **pkb-v350 — ширина относительно видимого экрана + закругление фото-кнопок:**
...
- [x] Закоммитить pkb-v341–pkb-v349 в master.
- [ ] Закоммитить pkb-v350 в master.
- [ ] Деплой на Timeweb.
