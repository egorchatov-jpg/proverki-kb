...
- **Дата:** 2026-08-19
- **Сессия:** Унификация высоты/ширины кнопок (pkb-v347)
- **Версия кода:** pkb-v347 (последний закоммиченный в master — pkb-v347, 8223eee)
- **Статус:** Закоммичено и запушено в master 2026-08-19

## Что сделано
1. **pkb-v347 — унификация высоты и ширины кнопок:**
...
- [x] Закоммитить pkb-v341–pkb-v347 в master.
- [ ] Деплой на Timeweb.
