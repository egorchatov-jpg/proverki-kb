...
module.exports = async (req, res) => {
  ...
  try {
    // Use Accept: application/vnd.github.raw to get the binary file directly
    // instead of the default JSON wrapper with base64-encoded content.
    // This is ~3× faster and avoids the base64 decode step.
