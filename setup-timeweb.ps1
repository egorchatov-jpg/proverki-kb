...
Write-Host "   - Репозиторий: GitHub -> proverki-kb, ветка master, деплой вручную"
...
Write-Host "Гotово. Работа в master, тесты локально (npm start), деплой в Timeweb вручную — см. docs/release-workflow.md." -ForegroundColor Green
Write-Host ""
